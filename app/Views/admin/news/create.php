...
<?= $this->section('title') ?>Thêm Tin Tức<?= $this->endSection() ?>

<?= $this->section('content') ?>
<div class="container mx-auto px-4 py-6">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-gray-900">Thêm Tin Tức</h1>
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <form action="<?= site_url('admin/news/store') ?>" method="post">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="space-y-3">
                            ...
                            <div id="imagePreviewContainer" class="<?= empty(old('image_path')) ? 'hidden' : '' ?>">
                                <img id="imagePreview"
                                     src="<?= old('image_path') ?>"
                                     alt="Preview"
                                     class="w-full h-32 object-cover rounded border"
                                     style="<?= empty(old('image_path')) ? 'display: none;' : '' ?>">
                                <button type="button"
                                        ...
                                        style="<?= empty(old('image_path')) ? 'display: none;' : 'display: inline-block;' ?>">
