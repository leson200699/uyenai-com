...
<?= $this->section('title') ?>Thêm Bài Viết Kiến Thức<?= $this->endSection() ?>

<?= $this->section('content') ?>
<div class="bg-white shadow rounded-lg">
    <div class="px-6 py-4 border-b">
        <h1 class="text-2xl font-bold text-gray-900">Thêm Bài Viết Kiến Thức</h1>
    </div>

    <form action="<?= site_url('admin/knowledge/store') ?>" method="post" enctype="multipart/form-data" class="p-6">
        <?= csrf_field() ?>
                ...
                <div>
                    ...
                    <div class="space-y-3">
                        ...
                        <div id="imagePreviewContainer" class="hidden">
                            <img id="imagePreview" src="" alt="Preview" class="w-full h-32 object-cover rounded border">
                            <button type="button" 
